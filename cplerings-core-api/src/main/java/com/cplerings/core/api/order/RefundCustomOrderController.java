...
public class RefundCustomOrderController extends AbstractDataController<RefundCustomOrderInput, RefundCustomOrderOutput, ARefundInfo, RefundCustomOrderRequest, RefundCustomOrderResponse> {
    ...
    @Override
    protected APIMapper<RefundCustomOrderInput, RefundCustomOrderOutput, ARefundInfo, RefundCustomOrderRequest, RefundCustomOrderResponse> getMapper() {
