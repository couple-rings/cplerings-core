...
public interface APICreateCustomDesignVersionMapper extends APIMapper<CreateDesignVersionInput, CreateDesignVersionOutput, CreateDesignVersionData, CreateDesignVersionRequest, CreateDesignVersionResponse> {
}
