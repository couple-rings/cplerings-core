...
public class ViewCustomOrderResponse extends AbstractDataResponse<ACustomOrder> {

    public static Builder builder() {
        return new Builder();
    }

    public static final class Builder extends AbstractDataResponseBuilder<Builder, ViewCustomOrderResponse, ACustomOrder> {
