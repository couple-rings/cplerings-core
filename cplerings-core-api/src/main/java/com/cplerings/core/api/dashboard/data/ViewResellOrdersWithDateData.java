...
@Setter
@NoArgsConstructor
public class ViewResellOrdersWithDateData extends AbstractPaginatedData<CombinedOrder> {

    public static Builder builder() {
        return new Builder();
    }

    public static final class Builder extends AbstractPaginatedDataBuilder<Builder, ViewResellOrdersWithDateData, CombinedOrder> {
