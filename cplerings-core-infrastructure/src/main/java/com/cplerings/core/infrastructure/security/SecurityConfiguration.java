...
public class SecurityConfiguration {
    ...
    private void handleOrderAPI(HttpSecurity localHttp) throws Exception {
        localHttp.authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.POST, resolvePath(APIConstant.ASSIGN_TRANSPORTATION_ORDER_PATH))
                ...
                .authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.GET, resolvePath(APIConstant.VIEW_A_CUSTOM_ORDER_BY_ORDER_NO_PATH))
                        .hasAnyAuthority(RoleConstant.ROLE_STAFF))
                .authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.POST, resolvePath(APIConstant.REFUND_STANDARD_ORDER_PATH))
                        .hasAnyAuthority(RoleConstant.ROLE_STAFF));
    }
    ...
    private void handleStandardOrderAPI(HttpSecurity localHttp) throws Exception {
        localHttp.authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.POST, resolvePath(APIConstant.STANDARD_ORDER_PATH))
                ...
                .authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.GET, resolvePath(APIConstant.VIEW_A_STANDARD_ORDER_BY_ORDER_NO_PATH))
                        .hasAnyAuthority(RoleConstant.ROLE_STAFF))
                .authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.GET, resolvePath(APIConstant.CUSTOM_ORDER_PAYMENTS_PATH))
                        .hasAnyAuthority(RoleConstant.ROLE_CUSTOMER, RoleConstant.ROLE_STAFF))
                .authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.DELETE, resolvePath(APIConstant.CANCEL_CUSTOM_ORDER_PATH))
                        .hasAnyAuthority(RoleConstant.ROLE_CUSTOMER, RoleConstant.ROLE_STAFF));
    }
    ...
    private void handleCustomOrderAPI(HttpSecurity localHttp) throws Exception {
        localHttp.authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.POST, resolvePath(APIConstant.REFUND_CUSTOM_ORDER_PATH))
                        .hasAuthority(RoleConstant.ROLE_STAFF))
                .authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.POST, resolvePath(APIConstant.RESELL_CUSTOM_ORDER_PATH))
                        .hasAuthority(RoleConstant.ROLE_STAFF));
    }
    ...
    private void handleResellOrderAPI(HttpSecurity localHttp) throws Exception {
        localHttp.authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.GET, resolvePath(APIConstant.RESELL_ORDERS_PATH))
                        .hasAnyAuthority(RoleConstant.ROLE_STAFF, RoleConstant.ROLE_MANAGER, RoleConstant.ROLE_CUSTOMER))
                .authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.POST, resolvePath(APIConstant.RESELL_JEWELRY_PATH))
                        .hasAnyAuthority(RoleConstant.ROLE_STAFF))
    ...
    private void handleRevenueAPI(HttpSecurity localHttp) throws Exception {
        localHttp.authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.GET, resolvePath(APIConstant.REVENUE_PATH))
                ...
                .authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.GET, resolvePath(APIConstant.ORDERS_STATISTIC_PATH))
                        .hasAnyAuthority(RoleConstant.ROLE_MANAGER))
                .authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.GET, resolvePath(APIConstant.ORDERS_STATISTIC_PAGINATION_PATH))
                        .hasAnyAuthority(RoleConstant.ROLE_MANAGER))
                ...
                .authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.GET, resolvePath(APIConstant.TOP_5_CUSTOM_ORDER))
                        .hasAnyAuthority(RoleConstant.ROLE_MANAGER))
                .authorizeHttpRequests(config -> config.requestMatchers(HttpMethod.GET, resolvePath(APIConstant.TOTAL_PAYMENT_WITH_ORDER_TYPE))
                        .hasAnyAuthority(RoleConstant.ROLE_MANAGER));
    }
